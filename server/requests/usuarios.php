          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <?php
				  ...
				  {
	              	echo '<tr><td>'.$item['nome'].'</td><td><a href="?class=usuario&matricula='.$item['matricula'].'">'.$item['matricula'].'</a></td><td>'.$item['centro'].'</td><td>'.$item['versao'].'</td><td>'.$item['totalreq'].'</td></tr>';
				  }
